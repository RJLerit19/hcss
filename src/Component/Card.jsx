...
const Card = (props) => {
  return (
    <div>
      ...
      <div class="max-w-md xs:h-[full] sm:h-[350px] p-6 mb-5 border rounded-2xl shadow-sm bg-gray-800 border-gray-700">
        ...
        <p class="mb-3 ml-4 font-normal text-gray-300">{props.description}</p>
      </div>
    </div>
  );
};
