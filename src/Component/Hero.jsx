      ...
      <div className="absolute inset-0 flex justify-between items-center mx-10">
        ...
        <div className="px-4 pt-20 xs:hidden md:block md:max-w-[500px] lg:max-w-[600px]">
          <p className="text-lg font-lato tracking-wide lg:text-2xl">
            HCSS specializes in healthcare staffing, healthcare facility strikes
            and emergency staffing needs. With over 30 years experience we have
            helped staff some of the largest and most complicated healthcare
            strikes. We specialize in staffing hard to fill assignments with
            qualified healthcare professionals that have proven experience in
            the positions they are assigned to, to care for your patients.
          </p>
        </div>
      </div>
    </div>
